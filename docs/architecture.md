...
See [Validator Sidecar](sidecar.md) for the gRPC service implementation.

See [Aggregator Backend](backend.md) for the REST API and certificate aggregation.

See [User Client](user_client.md) for the Rust client library.

See [Tempo Integration](tempo_integration.md) for blockchain-specific details.
