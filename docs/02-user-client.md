...
Clients should reuse a fixed set of nonce keys rather than generating new keys per transaction. Creating new nonce keys incurs TIP-1000 state creation costs. See [Tempo Integration](05-tempo-integration.md) for details on nonce key economics.
...
See [Validator Sidecar](04-sidecar.md) for the gRPC service the client communicates with.

See [Tempo Integration](05-tempo-integration.md) for transaction format details.
