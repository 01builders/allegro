...
See [System Architecture](architecture.md) for the overall FastPay design.

See [Validator Sidecar](sidecar.md) for certificate issuance.

See [Protocol Specification](spec.md) for detailed protocol objects.
