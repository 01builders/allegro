//! Canonical hashing for tx_hash, effects_hash, qc_hash, and cert preimages.
...
mod tests {
    use fastpay_types::{
        Address, AssetId, Certificate, EffectsHash, Expiry, NonceKey, QcHash, TxHash, ValidatorId,
    };
